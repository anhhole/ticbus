...
import com.ticbus.backend.config.PropertiesConfig;
 ...
 */
@Component
public class TicbusException {

  private static PropertiesConfig propertiesConfig;

  @Autowired
  public TicbusException(PropertiesConfig propertiesConfig) {
    TicbusException.propertiesConfig = propertiesConfig;
  }
  ...
  private static String format(String template, String... args) {
    Optional<String> templateContent = Optional
